<header id="page-topbar">
    ...
    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        @if(Session::get('lang') == 'en')
            <img src="{{ asset('build/images/flags/us.svg') }}" alt="English" height="20">
        @else
            <img src="{{ asset('build/images/flags/mexico.svg') }}" alt="Español" height="20">
        @endif
    </button>
    <div class="dropdown-menu dropdown-menu-end">
        <!-- Español -->
        <a href="{{ url('index/sp') }}" class="dropdown-item notify-item language py-2" data-lang="sp" title="Español">
            <img src="{{ asset('build/images/flags/mexico.svg') }}" alt="Español" class="me-2" height="20">
            <span class="align-middle">Español</span>
        </a>

        <!-- Inglés -->
        <a href="{{ url('index/en') }}" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
            <img src="{{ asset('build/images/flags/us.svg') }}" alt="English" class="me-2" height="20">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ asset('images/avatar admin.jpg') }}" alt="avatar admin">

                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{Auth::user()->name}}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Fundador</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
