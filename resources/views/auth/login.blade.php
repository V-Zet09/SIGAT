  ...
  <div class="row h-100">
    ...
    <div class="col-md-6 d-none d-md-flex flex-column justify-content-center align-items-center bg-light">
      <div class="text-center p-5">
        <img src="{{ asset('images/logo-login.jpeg') }}" 
             alt="Logo SIGAT" 
                    ...
                    <div class="card-body p-4 fs-6">
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control fs-6 @error('email') is-invalid @enderror" id="username" name="email" value="{{ old('email') }}" placeholder="Ingresa tu usuario">
                                @error('email')
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('password.update') }}" class="text-muted small">¿Olvidaste la contraseña?</a>
                                </div>
                                <div class="position-relative">
                                    <input type="password" class="form-control fs-6 pe-5 @error('password') is-invalid @enderror" name="password" id="password-input" placeholder="Ingresa tu contraseña">
