                    ...
                    <form action="{{ url('/login') }}" method="POST" class="space-y-5 flex-1 text-sm md:text-base">
                        ...
                        <div>
                            ...
                            <input type="text" name="email" id="username" value="{{ old('email') }}"
                                   class="bg-gray-100 border border-gray-300 text-gray-800 rounded-lg shadow-sm focus:ring-green-600 focus:border-green-600 block w-full p-2.5"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="password-input"
                                       class="bg-gray-100 border border-gray-300 text-gray-800 rounded-lg shadow-sm focus:ring-green-600 focus:border-green-600 block w-full p-2.5 pr-10"
                        ...
                        <div>
                            <button id="btn-login" type="submit"
                                    class="w-full text-white bg-green-700/95 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-600 font-medium rounded-lg px-5 py-2.5 transition-all shadow-md hover:shadow-lg">
                                Iniciar sesión
                            </button>

                            <button id="btn-loading" disabled type="button"
                                    class="hidden w-full text-white bg-green-700/95 focus:ring-4 focus:outline-none focus:ring-green-600 font-medium rounded-lg px-5 py-2.5 inline-flex items-center justify-center rounded-lg">
