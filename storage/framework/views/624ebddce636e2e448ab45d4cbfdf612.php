            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarUsuarios">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('dashboard-crear-usuario')); ?>" class="nav-link">
...
</script><?php /**PATH C:\Users\DELL\Documents\GitHub\SIGAT\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>