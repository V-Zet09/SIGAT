<header id="page-topbar">
    ...
    <div class="dropdown-menu dropdown-menu-end">
        ...
        <a href="<?php echo e(url('index/en')); ?>" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
            <img src="<?php echo e(asset('build/images/flags/us.svg')); ?>" alt="English" class="me-2" height="20">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php echo e(asset('images/avatar admin.jpg')); ?>" alt="avatar admin">
...
<?php /**PATH C:\Users\jorge\OneDrive\Documentos\GitHub\SIGAT\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>