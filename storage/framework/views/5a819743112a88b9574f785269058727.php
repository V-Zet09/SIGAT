...
<p style="color: red">Esta es la vista correcta</p>
                    ...
                    <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                            ...
                            <div class="py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><?php echo e($totalActividades); ?></h2>
                                    </div>
                                </div>
                             </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><?php echo e($actividadesSemana); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="ri-checkbox-circle-line display-6 text-muted cfs-22"></i>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><?php echo e($aprobadas); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="ri-loader-line display-6 text-muted cfs-22"></i>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><?php echo e($revision); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="ri-alert-line display-6 text-muted cfs-22"></i>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22"><?php echo e($departamentosSinActividad); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/dashboard_presidente.blade.php ENDPATH**/ ?>