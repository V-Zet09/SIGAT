            ...
            <div class="alert border-dashed alert-danger" role="alert">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-2">
                        ...
                        <button type="button" class="btn ps-0 btn-sm btn-link text-danger text-uppercase material-shadow-none">Add Gift
                            Wrap</button>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/apps-ecommerce-cart.blade.php ENDPATH**/ ?>