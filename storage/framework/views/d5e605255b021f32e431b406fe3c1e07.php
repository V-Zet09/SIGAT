...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img src="<?php echo e(URL::asset('build/images/blog/img-1.jpg')); ?>" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img src="<?php echo e(URL::asset('build/images/blog/img-2.jpg')); ?>" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img src="<?php echo e(URL::asset('build/images/blog/img-3.jpg')); ?>" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img src="<?php echo e(URL::asset('build/images/blog/img-4.jpg')); ?>" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img src="<?php echo e(URL::asset('build/images/blog/img-5.jpg')); ?>" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img src="<?php echo e(URL::asset('build/images/blog/img-6.jpg')); ?>" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/pages-blog-grid.blade.php ENDPATH**/ ?>