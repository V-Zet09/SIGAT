            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/dashboard-administrador" class="nav-link"><?php echo app('translator')->get('Administrador'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-presidente-municipal" class="nav-link"><?php echo app('translator')->get('Presidente Municipal'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-sindico-procurador" class="nav-link"><?php echo app('translator')->get('Síndico Procurador'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-regidor" class="nav-link"><?php echo app('translator')->get('Regidor'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-director-de-area" class="nav-link"><?php echo app('translator')->get('Director de Área'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-auxiliar-area" class="nav-link"> <?php echo app('translator')->get('Auxiliar de Área'); ?></a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="dashboard-generar-informe" class="nav-link"><?php echo app('translator')->get('Generar Informe'); ?></a>
                            </li>
                <li class="nav-item">
