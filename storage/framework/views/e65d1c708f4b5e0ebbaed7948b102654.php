    ...
    <div class="col-xxl-9">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="<?php echo e(URL::asset('build/images/nft/img-04.jpg')); ?>" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center mb-3">
                    <button class="btn btn-link text-success mt-2 material-shadow-none"><i class="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load more </button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-03.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-04.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-05.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-02.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jp')); ?>g" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
...
<script src="<?php echo e(URL::asset('build/js/pages/apps-nft-auction.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/apps-nft-auction.blade.php ENDPATH**/ ?>