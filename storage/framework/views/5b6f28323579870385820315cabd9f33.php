                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-muted">
                                        ...
                                        <div>
                                            <button type="button"
                                                class="btn btn-link link-success p-0 material-shadow-none">Read
                                                more</button>
                                        </div>
                                    ...
                                    <form class="mt-4">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 text-end">
                                                <button type="button"
                                                    class="btn btn-ghost-secondary btn-icon waves-effect me-1 material-shadow-none"><i
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <button type="button"
                                                            class="btn btn-light btn-sm material-shadow-none">Message</button>
                                                        <div class="dropdown">
                                                            <button
                                                                class="btn btn-icon btn-sm fs-16 text-muted dropdown material-shadow-none"
                                                                type="button" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="ri-more-fill"></i>
                                                            </button>
                    ...
                    <div class="mx-n4 px-4" data-simplebar style="max-height: 225px;">
                        <div class="vstack gap-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <button type="button"
                                        class="btn btn-light btn-sm material-shadow-none">Add</button>
                                </div>
                            </div>
                            <!-- end member item -->
                            <div class="d-flex align-items-center">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/apps-projects-overview.blade.php ENDPATH**/ ?>