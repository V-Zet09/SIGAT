                            ...
                            <div class="text-center mt-sm-5 pt-4">
                                ...
                                <div class="row justify-content-center mb-5">
                                    <div class="col-xl-4 col-lg-8">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/maintenance.png')); ?>" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/pages-maintenance.blade.php ENDPATH**/ ?>