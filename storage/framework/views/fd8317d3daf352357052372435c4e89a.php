            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav flex-column">
                            <li class="nav-item"><a href="<?php echo e(route('dashboard-administrador')); ?>" class="nav-link"><i class="fas fa-user-shield"></i> Administrador</a></li>
                            <li class="nav-item"><a href="<?php echo e(route('dashboard-presidente-municipal')); ?>" class="nav-link"><i class="fas fa-user-tie"></i> Presidente Municipal</a></li>
                            <li class="nav-item"><a href="<?php echo e(route('dashboard-sindico-procurador')); ?>" class="nav-link"><i class="fas fa-balance-scale"></i> Síndico Procurador</a></li>
                            <li class="nav-item"><a href="<?php echo e(route('dashboard-regidor')); ?>" class="nav-link"><i class="fas fa-users"></i> Regidor</a></li>
                            <li class="nav-item"><a href="<?php echo e(route('dashboard-director-de-area')); ?>" class="nav-link"><i class="fas fa-user-cog"></i> Director de Área</a></li>
                            <li class="nav-item"><a href="<?php echo e(route('dashboard-auxiliar-area')); ?>" class="nav-link"><i class="fas fa-user-clock"></i> Auxiliar de Área</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(url('dashboard-generar-informe')); ?>" class="nav-link">Generar Informe</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(url('dashboard-users')); ?>" class="nav-link">CRUD</a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(url('dashboard-crear-usuario')); ?>" class="nav-link">Crear usuario</a>
                            </li>
                        </ul>
                    </div>
                </li>
