            ...
            <div class="card">
                ...
                <div>
                    <div id="market-overview" data-colors='["--vz-success", "--vz-warning"]'
                        ...
                        data-colors-galaxy='["--vz-primary-rgb, 0.65", "--vz-primary"]' class="apex-charts mt-n4"></div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a href="apps-nft-collections" type="button"
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a href="apps-nft-creators" type="button"
                        class="btn btn-soft-primary btn-sm flex-shrink-0 material-shadow-none">
                        See All <i class="ri-arrow-right-line align-bottom"></i>
                    </a>
                </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\zaet_\OneDrive\Escritorio\AYUNTAMIENTO\resources\views/dashboard-auxiliar-area.blade.php ENDPATH**/ ?>