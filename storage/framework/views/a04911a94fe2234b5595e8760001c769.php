        ...
        <div class="col-xl-6">
            <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="#!" class="btn btn-soft-primary btn-sm material-shadow-none">View All Companies <i
                        ...
                        <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#!" class="btn btn-link btn-sm material-shadow-none">View More <i
                                                class="ri-arrow-right-line align-bottom"></i></a>
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="card-body p-0 pb-2">
                    <div class="w-100">
                        <div id="line_chart_dashed" data-colors='["--vz-success", "--vz-info", "--vz-primary"]'
                            ...
                            data-colors-corporate='["--vz-secondary", "--vz-success", "--vz-primary"]' class="apex-charts"
                            dir="ltr"></div>
                    </div>
                </div><!-- end card body -->
            </div><!-- end card -->
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jorge\OneDrive\Documentos\GitHub\SIGAT\resources\views/dashboard-job.blade.php ENDPATH**/ ?>