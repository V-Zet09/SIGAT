                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt=""
                                        class="avatar-sm rounded material-shadow-none">
                                </div>
                            ...
                            <div class="row g-2">
                                <div class="col-sm-6">
                                    <div class="d-flex border border-dashed p-2 rounded position-relative">
                                        <div class="flex-shrink-0 avatar-xs">
                                            <div
                                                class="avatar-title bg-danger-subtle text-danger fs-15 rounded material-shadow-none">
                                ...
                                <div class="col-sm-6">
                                    <div class="d-flex border border-dashed p-2 rounded position-relative">
                                        <div class="flex-shrink-0 avatar-xs">
                                            <div
                                                class="avatar-title bg-info-subtle text-info fs-15 rounded material-shadow-none">
                    ...
                    <div class="timeline-item left">
                        ...
                        <div class="content">
                            ...
                            <div class="avatar-group mb-2">
                                <a href="javascript: void(0);" class="avatar-group-item material-shadow-none"
                                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title=""
                            ...
                            <div class="row border border-dashed rounded gx-2 p-2">
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt=""
                                        class="img-fluid rounded material-shadow-none">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                            ...
                            <div class="col-12">
                                <div class="timeline-box material-shadow">
                                    <div class="timeline-text">
                                        ...
                                        <div class="row border border-dashed rounded gx-2 p-2">
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>"
                                                        alt="" class="img-fluid rounded material-shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>"
                                                        alt="" class="img-fluid rounded material-shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>"
                                                        alt="" class="img-fluid rounded material-shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>"
                                                        alt="" class="img-fluid rounded material-shadow"></a>
                                            </div>
                                            <!--end col-->
                                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/pages-timeline.blade.php ENDPATH**/ ?>