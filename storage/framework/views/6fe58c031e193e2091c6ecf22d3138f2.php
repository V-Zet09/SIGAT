                    ...
                    <div class="live-preview">
                        <div>
                            <div>
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded material-shadow" alt="rounded">
                                        <p><code>.rounded</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-top material-shadow" alt="rounded-top">
                                        <p><code>.rounded-top</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-end material-shadow" alt="rounded-end">
                                        <p><code>.rounded-end</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-bottom material-shadow" alt="rounded-bottom">
                                        <p><code>.rounded-bottom</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-start material-shadow" alt="rounded-start">
                                        <p><code>.rounded-start</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-circle material-shadow" alt="rounded-circle">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" class="avatar-md w-auto rounded-pill material-shadow" alt="rounded-pill">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-0 material-shadow" alt="rounded-0">
                                        <p><code>.rounded-0</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-1 material-shadow" alt="rounded-1">
                                        <p><code>.rounded-1</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-2 material-shadow" alt="rounded-2">
                                        <p><code>.rounded-2</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-3 material-shadow" alt="rounded-3">
                                        <p><code>.rounded-3</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-4 material-shadow" alt="rounded-4">
                                        <p><code>.rounded-4</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-5 material-shadow" alt="rounded-5">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="hstack gap-3">
                                ...
                                <div class="vr"></div>
                                <button type="button" class="btn btn-outline-secondary material-shadow-none">Reset</button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/ui-utilities.blade.php ENDPATH**/ ?>