...
<div class="row">
    ...
    <div class="col-xl-4">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                <div id="user_device_pie_charts" data-colors='["--vz-primary", "--vz-warning", "--vz-info"]' data-colors-modern='["--vz-primary", "--vz-secondary", "--vz-warning"]' class="apex-charts" dir="ltr"></div>
    ...
    <div class="col-xxl-4 col-md-6">
        <div class="card card-height-100">
            ...
            <div class="card-body pb-0">
                <div id="deal-type-charts" data-colors='["--vz-info", "--vz-secondary"]' data-colors-modern='["--vz-info", "--vz-secondary"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card body -->
        </div><!-- end card -->
    </div><!-- end col -->
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/apps-job-statistics.blade.php ENDPATH**/ ?>