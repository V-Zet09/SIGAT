...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p><strong>Área:</strong> <?php echo e($actividad->area); ?></p>
            <p><strong>Tipo de Actividad:</strong> <?php echo e($actividad->tipo_actividad); ?></p>
            ...
            <p><strong>Municipio:</strong> <?php echo e($actividad->municipio); ?></p>
            <p><strong>Archivo:</strong>
                <?php if($actividad->archivo): ?>
                    <a href="<?php echo e(asset('storage/' . $actividad->archivo)); ?>" target="_blank">Ver archivo</a>
                <?php else: ?>
                    No adjunto
                <?php endif; ?>
            </p>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\GitHub\SIGAT\resources\views/show.blade.php ENDPATH**/ ?>