...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.images'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img class="rounded material-shadow" alt="200x200" width="200" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
                                    <img class="rounded-circle avatar-xl material-shadow" alt="200x200" src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" data-holder-rendered="true">
                                </div>
                            </div><!-- end col -->
                        </div>
...
<code>&lt;!-- Rounded Image --&gt;
&lt;img class=&quot;rounded material-shadow&quot; alt=&quot;200x200&quot; width=&quot;200&quot; src=&quot;build/images/small/img-4.jpg&quot;&gt;</code>

<code>&lt;!-- Rounded-circle Image --&gt;
&lt;img class=&quot;rounded-circle avatar-xl material-shadow&quot; alt=&quot;200x200&quot; src=&quot;build/images/users/avatar-4.jpg&quot;&gt;</code></pre>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="rounded avatar-xxs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jpg')); ?>" alt="" class="rounded avatar-xs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="rounded avatar-sm material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-sm</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="rounded avatar-md material-shadow">
                                            <p class="mt-2  mb-lg-0"><code>avatar-md</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="rounded avatar-lg material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-lg</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" alt="" class="rounded avatar-xl material-shadow">
                            ...
                            <div class="col-md-12">
                                <div class="row g-3 mt-5">
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="rounded-circle avatar-xxs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jpg')); ?>" alt="" class="rounded-circle avatar-xs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="rounded-circle avatar-sm material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-sm</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="rounded-circle avatar-md material-shadow">
                                            <p class="mt-2  mb-lg-0"><code>avatar-md</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="rounded-circle avatar-lg material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-lg</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" alt="" class="rounded-circle avatar-xl material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xl</code></p>
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
...
&lt;img src=&quot;build/images/users/avatar-2.jpg&quot; alt=&quot;&quot; class=&quot;rounded avatar-xxs material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-10.jpg&quot; alt=&quot;&quot; class=&quot;rounded avatar-xs material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-3.jpg&quot; alt=&quot;&quot; class=&quot;rounded avatar-sm material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-4.jpg&quot; alt=&quot;&quot; class=&quot;rounded avatar-md material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-5.jpg&quot; alt=&quot;&quot; class=&quot;rounded avatar-lg material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-8.jpg&quot; alt=&quot;&quot; class=&quot;rounded avatar-xl material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-2.jpg&quot; alt=&quot;&quot; class=&quot;rounded-circle avatar-xxs material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-10.jpg&quot; alt=&quot;&quot; class=&quot;rounded-circle avatar-xs material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-3.jpg&quot; alt=&quot;&quot; class=&quot;rounded-circle avatar-sm material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-4.jpg&quot; alt=&quot;&quot; class=&quot;rounded-circle avatar-md material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-5.jpg&quot; alt=&quot;&quot; class=&quot;rounded-circle avatar-lg material-shadow&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-8.jpg&quot; alt=&quot;&quot; class=&quot;rounded-circle avatar-xl material-shadow&quot;&gt;</code></pre>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
                                ...
                                <div class="mt-lg-0 mt-3">
                                    ...
                                    <div class="avatar-group">
                                        <div class="avatar-group-item material-shadow">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                        </div>
                                        <div class="avatar-group-item material-shadow">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                        </div>
                                        <div class="avatar-group-item material-shadow">
                                            <div class="avatar-sm">
                                        ...
                                        <div class="avatar-group-item material-shadow">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" class="figure-img img-fluid rounded" alt="...">
                                    <figcaption class="figure-caption">A caption for the above image.</figcaption>
                                </figure>
                            </div>
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" class="figure-img img-fluid rounded" alt="...">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maria\Documents\GitHub\SIGAT\resources\views/ui-images.blade.php ENDPATH**/ ?>